...
import './Allcss.css'
 class Home extends React.Component{
     render(){
        console.log('Home Page =========>',this.props.data.name)
         return(
             <div>
...
<button style={{backgroundColor: "#008CBA", padding:"5px 32px" ,border: "none",color:'white'}} onClick={()=>this.props.history.push("about")}>About</button>
             </center>
<br />
